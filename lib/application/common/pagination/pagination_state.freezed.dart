...
mixin _$PaginationState<T> {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(NetworkException exception, StackTrace? stacktrace)?
        error,
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(List<T> items)? data,
    TResult Function()? loading,
    TResult Function(NetworkException exception, StackTrace? stacktrace)? error,
    TResult Function(List<T> items)? onGoingLoading,
    TResult Function(
            List<T> items, NetworkException exception, StackTrace? stacktrace)?
        onGoingError,
...
abstract class _$$_ErrorCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({NetworkException exception, StackTrace? stacktrace});
...
class _$_Error<T> implements _Error<T> {
  ...
  @override
  String toString() {
    return 'PaginationState<$T>.error(exception: $exception, stacktrace: $stacktrace)';
  }
...
abstract class _Error<T> implements PaginationState<T> {
  const factory _Error(final NetworkException exception,
...
class _$_OnGoingError<T> implements _OnGoingError<T> {
  const _$_OnGoingError(final List<T> items, this.exception, [this.stacktrace])
      : _items = items;
  ...
  @override
  String toString() {
    return 'PaginationState<$T>.onGoingError(items: $items, exception: $exception, stacktrace: $stacktrace)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_items), exception, stacktrace);
  ...
  TResult when<TResult extends Object?>({
    ...
    return onGoingError(items, exception, stacktrace);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return onGoingError?.call(items, exception, stacktrace);
  }
...
abstract class _OnGoingError<T> implements PaginationState<T> {
  const factory _OnGoingError(
      final List<T> items, final NetworkException exception,
